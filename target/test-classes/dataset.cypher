...
(SacHermes{name:'SacHermes'}), (EscarppinsJinny{name:'EscarppinsJinny'}), (ShoppingCart1{name:'ShoppingCart1'}), (ShoppingCart2{name:'ShoppingCart2'}), (Date15Janvier2012{name:'Date15Janvier2012'}), (Matin{name:'Matin'}), (Lundi{name:'Lundi'}), 
...
ShoppingCart1-[:validerLe]->Date15Janvier2012, ShoppingCart2-[:validerLe]->Date15Janvier2012,
